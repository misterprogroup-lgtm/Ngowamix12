...
export const metadata: Metadata = {
  ...
  description: 'Consultez les conditions générales d\'utilisation de Ngowamix : inscriptions, abonnements, paiements, droits et obligations.',
  alternates: { canonical: '/terms' },
  openGraph: { title: 'Conditions générales - Ngowamix', description: 'Conditions générales d\'utilisation de Ngowamix.' },
  twitter: { title: 'Conditions générales - Ngowamix', description: 'Conditions générales d\'utilisation de Ngowamix.' },
};
    ...
    <div className="container mx-auto py-12 pb-24 max-w-4xl">
      ...
      <div className="prose prose-sm max-w-none text-text-secondary space-y-8">
        ...
        <section>
          ...
          <p>
            Les albums et singles peuvent être achetés individuellement. Les paiements sont sécurisés et traités par notre prestataire de paiement PawaPay. Les prix sont affichés en Francs CFA (XOF) et sont TVA incluse.
          </p>
          <p>
