              ...
              <div key={ticket.id} className="rounded-xl border border-border bg-surface overflow-hidden">
                ...
                >
                  <div className="h-14 w-14 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                    <Ticket className={`h-6 w-6 ${ticket.type === 'VVIP' ? 'text-accent' : ticket.type === 'VIP' ? 'text-primary' : 'text-text-muted'}`} />
                  </div>
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <p className="text-xs text-text-muted mt-1">
                      {ticket.type === 'VVIP' ? 'VVIP' : ticket.type === 'VIP' ? 'VIP' : 'Standard'}
                    </p>
                  </div>
                  {isExpanded ? (
                  ...
                  <div className="border-t border-border p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="font-medium text-text-primary">{ticket.type === 'VVIP' ? 'VVIP' : ticket.type === 'VIP' ? 'VIP' : 'Standard'}</p>
                      </div>
                      <div className="space-y-1">
