...
export const metadata: Metadata = {
  ...
  description: 'Consultez la politique de confidentialité de Ngowamix : collecte des données, cookies, droits des utilisateurs et protection de la vie privée.',
  alternates: { canonical: '/privacy' },
  openGraph: { title: 'Politique de confidentialité - Ngowamix', description: 'Politique de confidentialité de Ngowamix.' },
  twitter: { title: 'Politique de confidentialité - Ngowamix', description: 'Politique de confidentialité de Ngowamix.' },
};

export default function PrivacyPage() {
  return (
    <div className="container mx-auto py-12 pb-24 max-w-4xl">
      ...
      <div className="prose prose-sm max-w-none text-text-secondary space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>Données de paiement : informations de transaction (traitées par notre prestataire PawaPay)</li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            <li><strong>Prestataire de paiement</strong> — PawaPay pour le traitement des transactions</li>
