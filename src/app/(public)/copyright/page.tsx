  ...
  return (
    <div className="container mx-auto py-8 pb-24 max-w-3xl">
      ...
      <div className="space-y-4 text-text-secondary text-sm">
        ...
        <h2 className="text-lg font-semibold text-text-primary">Contenu protégé</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-text-primary">Signalement</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-text-primary">Artistes partenaires</h2>
        <p>
