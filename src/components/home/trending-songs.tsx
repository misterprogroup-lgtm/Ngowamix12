        ...
        <Link
          ...
          <div className="relative aspect-square rounded-lg overflow-hidden bg-[#141414] border border-[#ffffff08] transition-all duration-200 group-hover:border-primary/20">
            ...
            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center">
              <div className="h-12 w-12 rounded-full bg-primary text-white shadow-lg shadow-primary/30 flex items-center justify-center translate-y-2 group-hover:translate-y-0 transition-transform duration-200">
